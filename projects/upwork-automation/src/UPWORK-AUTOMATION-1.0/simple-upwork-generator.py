...
DARK_THEME_TEMPLATE_PATH = "/root/homelab-docs/projekt-ai-website/templates/dark-proposal-template.html"
    ...
    <body>
        <div class="container">
            <header>
                ...
                <p class="subtitle">Generate winning proposals with AI</p>
            </header>
