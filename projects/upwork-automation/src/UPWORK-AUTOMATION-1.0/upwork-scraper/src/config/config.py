...
HOST = "0.0.0.0"
DEBUG = True
SECRET_KEY = "upwork-scraper-secret-key-2025"

# Database settings
DATABASE_PATH = "upwork_scraper.db"

# Upwork credentials
# IMPORTANT: Replace these with your actual Upwork credentials
UPWORK_USER_NAME = "Tim"  # First name shown on Upwork profile
UPWORK_USERNAME = "tim@club77.com.au"  # Replace with your Upwork email
UPWORK_PASSWORD = "Club77Sydne"  # Replace with your Upwork password
...
CHROME_VERSIONS = [
    ...
    92,
    123,
    137,  # Added to match the installed Chrome version
]
MAX_ATTEMPTS = 3
